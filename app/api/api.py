...
#Adding the address of user and saving it
...
#code for creating the order from customers side
...
#code for the HELP page where customer can submit their queries related to app
